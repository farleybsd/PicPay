...
namespace PicPay.Simplificado.Application.Mapper
{
    ...
    {
        public UsuarioComumCreateCommand ConvertToCommandCreate(UsuarioComumCreateRequest request) => new UsuarioComumCreateCommand(request.NomeCompleto, request.Cpf, request.Email);
